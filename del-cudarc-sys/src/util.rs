...
pub fn set_consecutive_sequence(stream: cu::CUstream, d_in: &mut cu::CUdeviceptr, num_d_in: usize) {
    let (func, _mdl) =
        crate::load_function_in_module(del_cudarc_kernel::UTIL, "gpu_set_consecutive_sequence");
